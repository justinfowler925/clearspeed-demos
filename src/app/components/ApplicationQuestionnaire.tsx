...
export function ApplicationQuestionnaire({ onNavigate }: ApplicationQuestionnaireProps) {
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="mb-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            To complete your insurance application, please answer a few additional questions using the voice 
        ...
        <div className="flex justify-center">
          <div id="questionnaire-container" className="shadow-2xl rounded-lg overflow-hidden">
            <iframe 
              ...
              src={`https://guide.clearspeed.com/us?embedded=true&questionnaire_id=019ba922-c303-7685-a110-55f69be2e69c&reference_number=${referenceNumber}`}
              width="420"
              height="640"
        ...
        <div className="mt-12 max-w-3xl mx-auto">
          ...
          <div className="flex gap-4 mt-8">
            <Button 
              onClick={() => onNavigate('auto-quote-results')}
              variant="outline"
              className="flex-1"
            >
              Back
